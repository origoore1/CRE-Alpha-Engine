...
ANCHOR_NAMES    = ['rewe', 'edeka', 'kaufland', 'aldi', 'lidl', 'penny', 'netto',
                   'obi', 'bauhaus', 'hornbach', 'mediamarkt', 'saturn', 'dm ',
                   'rossmann', 'müller']

GREST_BY_STATE = {
    'Bayern': 0.035, 'Baden-Württemberg': 0.050, 'Berlin': 0.060,
    'Brandenburg': 0.065, 'Bremen': 0.050, 'Hamburg': 0.055,
    'Hessen': 0.060, 'Mecklenburg-Vorpommern': 0.060,
    'Niedersachsen': 0.050, 'Nordrhein-Westfalen': 0.065,
    'Rheinland-Pfalz': 0.050, 'Saarland': 0.065,
    'Sachsen': 0.055, 'Sachsen-Anhalt': 0.050,
        ...
        for i, row in df.iterrows():
            ...
            if area > 0:
                tenants.append({
                    ...
                    'cpi_passthrough': 0.75 if cpi == 'Y' else 0,
